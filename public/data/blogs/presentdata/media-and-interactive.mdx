...
Here are Markdown/MDX-style examples for **Media & Interactive Components**, assuming a CMS or MDX environment that supports rich media components:
...
Let me know if your rendering engine needs fallback markdown or alternate syntax.
